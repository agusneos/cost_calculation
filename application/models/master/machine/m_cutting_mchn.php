...
class M_cutting_mchn extends CI_Model
{    
    static $table = 'machine_cutting';
    ...
    function index()
    {
        ...
        $offset = ($page-1)*$rows;      
        $sort   = isset($_POST['sort']) ? strval($_POST['sort']) : 'Kode_mchncutt';
    ...
    function update($Kode_mchncutt)
    {
        $this->db->where('Kode_mchncutt', $Kode_mchncutt);
    ...
    function delete($Kode_mchncutt)
    {
        return $this->db->delete(self::$table, array('Kode_mchncutt' => $Kode_mchncutt)); 
    }
...
/* End of file m_cutting_mchn.php */
/* Location: ./application/models/master/machine/m_cutting_mchn.php */