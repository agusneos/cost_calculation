...
class M_heading_mchn extends CI_Model
{    
    static $table = 'machine_heading';
    ...
    function index()
    {
        ...
        $offset = ($page-1)*$rows;      
        $sort   = isset($_POST['sort']) ? strval($_POST['sort']) : 'Kode_mchnhead';
    ...
    function create()
    {
        return $this->db->insert(self::$table,array(
            ...
            'Mchn_heading'=>$this->input->post('Mchn_heading',true),
    ...
    function update($Kode_mchnhead)
    {
        $this->db->where('Kode_mchnhead', $Kode_mchnhead);
    ...
    function delete($Kode_mchnhead)
    {
        return $this->db->delete(self::$table, array('Kode_mchnhead' => $Kode_mchnhead)); 
    }
...
/* End of file m_heading_mchn.php */
/* Location: ./application/models/master/machine/m_heading_mchn.php */