...
class M_slotting_mchn extends CI_Model
{    
    static $table = 'machine_slotting';
    ...
    function index()
    {
        ...
        $offset = ($page-1)*$rows;      
        $sort   = isset($_POST['sort']) ? strval($_POST['sort']) : 'Kode_mchnslott';
    ...
    function update($Kode_mchnslott)
    {
        $this->db->where('Kode_mchnslott', $Kode_mchnslott);
    ...
    function delete($Kode_mchnslott)
    {
        return $this->db->delete(self::$table, array('Kode_mchnslott' => $Kode_mchnslott)); 
    }
...
/* End of file m_slotting_mchn.php */
/* Location: ./application/models/master/machine/m_slotting_mchn.php */