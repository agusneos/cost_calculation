...
class M_trimming_mchn extends CI_Model
{    
    static $table = 'machine_trimming';
    ...
    function index()
    {
        ...
        $offset = ($page-1)*$rows;      
        $sort   = isset($_POST['sort']) ? strval($_POST['sort']) : 'Kode_mchntrimm';
    ...
    function update($Kode_mchntrimm)
    {
        $this->db->where('Kode_mchntrimm', $Kode_mchntrimm);
    ...
    function delete($Kode_mchntrimm)
    {
        return $this->db->delete(self::$table, array('Kode_mchntrimm' => $Kode_mchntrimm)); 
    }
...
/* End of file m_trimming_mchn.php */
/* Location: ./application/models/master/machine/m_trimming_mchn.php */