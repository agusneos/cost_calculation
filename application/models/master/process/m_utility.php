...
{    
    ...
    return $this->db->insert(self::$table,array(
            ...
            'Biaya_per_year'=>$this->input->post('Biaya_per_year',true),
...
/* End of file m_utility.php */
/* Location: ./application/models/master/process/m_utility.php */