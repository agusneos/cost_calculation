...
{    
	...
	if (!empty($filterRules)){
        ...
        $this->db->select('a.Id AS Id, Category, Diameter, Min_panjang, Max_panjang, Cost, Currency, Tgl_update');
...
/* Location: ./application/models/master/m_heading1.php */