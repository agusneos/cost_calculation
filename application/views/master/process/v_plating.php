...
<script type="text/javascript">
    ...
    $('#grid-master_plating').datagrid({view:scrollview,remoteFilter:true,
        url:'<?php echo site_url('master/process/plating/index'); ?>?grid=true'})
    ...
    function masterplatingCreate() {
        ...
        url = '<?php echo site_url('master/process/plating/create'); ?>';
    }
    ...
    function masterplatingUpdate() {
        ...
        if(row){
            ...
            url = '<?php echo site_url('master/process/plating/update'); ?>/' + row.Id;            
        }
        else
        {
    ...
    function masterplatingHapus(){
        ...
        if (row){
            $.messager.confirm('Konfirmasi','Anda yakin ingin menghapus plating '+row.Name+' ?',function(r){
                if (r){
                    $.post('<?php echo site_url('master/process/plating/delete'); ?>',{Id:row.Id},function(result){
                        if (result.success){
                            $('#grid-master_plating').datagrid('reload');
                            $.messager.show({
                                title: 'Info',
    ...
    <form id="fm-master_plating" method="post" novalidate>        
        <div class="fitem">
            ...
            <input id="Kode_Supp" name="Kode_Supp" class="easyui-combobox"  data-options="
                url:'<?php echo site_url('master/process/plating/getSupplier'); ?>',
        ...
        <div class="fitem">
            ...
            url:'<?php echo site_url('master/process/plating/enumCurrency'); ?>',
...
<!-- Location: ./application/views/master/process/v_plating.php -->