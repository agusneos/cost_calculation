...
<table id="grid-transaksi_calculationAppMktStaff"
    ...
    <thead data-options="frozen:true">
        ...
        <thead>
            ...
            <th data-options="field:'Kode_plating2'"            width="100" align="center" sortable="true">Kode Plating2</th>
            <th data-options="field:'Price_plating2'"           width="100" align="center" sortable="true">Price Plating2</th>
            <th data-options="field:'Currency_plating2'"        width="100" align="center" sortable="true">Currency Plating2</th>
            <th data-options="field:'Plating2_cost'"            width="100" align="center" sortable="true">Plating2 Cost</th>
...
<script type="text/javascript">
    ...
    $('#Quantity').numberbox('textbox').keypress(function(e) {
        ...
        $('#bta').keyup(function(e) {
         ...
         var exr = $('#Exch_rate').numberbox('getValue');
                ...
                $('#Exch_rate_plating2').numberbox('setValue',exr);
    ...
    function plating2_cost()
    {
        
        var prc = $('#Price_plating2').numberbox('getValue');
        var cur = $('#Currency_plating2').textbox('getValue');
        var exr = $('#Exch_rate_plating2').numberbox('getValue');
        if( cur == 'USD'){
            $('#Plating2_cost').numberbox('setValue', (eval(prc)*eval(exr)));
        }
        else {
            $('#Plating2_cost').numberbox('setValue', (eval(prc)));
        }   
    }
</script>
        ...
        <div class="easyui-tabs" style="width:545px;height:510px">
            ...
            <div title="Process Cost" style="padding:10px">
                <div class="easyui-tabs" data-options="fit:true,plain:true">
                    ...
                    <div title="Turret/Auto/Bor (Int)" style="padding:10px;">
                        <div class="fitem">
                    ...
                    <div title="Turret (Ext)" style="padding:10px;">
                         <div class="fitem">
                    ...
                    <div title="Furnace (kg)" style="padding:10px;">
                         <div class="fitem">
                    ...
                    <div title="Furnace (pcs)" style="padding:10px;">
                         <div class="fitem">
                     ...
                     <div title="Plating (kg)" style="padding:10px;">
                         <div class="fitem">
                    ...
                    <div title="Plating (pcs)" style="padding:10px;">
                         <div class="fitem">
                            <label for="type">Kode Plating2</label>
                            <input id="Kode_plating2" name="Kode_plating2" class="easyui-combogrid" data-options="
                                panelWidth  : 250,
                                idField     : 'Id',
                                textField   : 'Name',
                                url         : '<?php echo site_url('transaksi/calculation/getPlating2'); ?>',
                                columns     : [[
                                    {field: 'Id',           title: 'Id',            width: 40},
                                    {field: 'Kode_Supp',    title: 'Kode Supp',     width: 70},
                                    {field: 'Name',         title: 'Jenis Plating 2', width: 120}
                                    ]],
                                onSelect: function(rowIndex, rowData) {
                                var g = $('#Kode_plating2').combogrid('grid');	// get datagrid object
                                var r = g.datagrid('getSelected');	// get the selected row
               
                                $('#Price_plating2').numberbox('setValue', r.Price);
                                $('#Currency_plating2').textbox('setValue', r.Currency);
                                plating2_cost();
                                }"  
                                />                  
                        </div>
                        <div class="fitem">
                            <label for="type">Price</label>
                            <input type="text" id="Price_plating2" name="Price_plating2" class="easyui-numberbox" data-options="precision:6, groupSeparator:'.', decimalSeparator:',', readonly: true"/>
                        </div>
                        <div class="fitem">
                            <label for="type">Currency</label>
                            <input type="text" id="Currency_plating2" name="Currency_plating2" class="easyui-textbox" data-options="readonly: true"/>
                        </div> 
                        <div class="fitem">
                            <label for="type">Exchange Rate</label>
                            <input type="text" id="Exch_rate_plating2" name="Exch_rate_plating2" class="easyui-numberbox" data-options="precision:0, groupSeparator:'.', decimalSeparator:',', readonly: true"/>
                        </div>                
                        <div class="fitem">
                            <label for="type">Plating 2 Cost</label>
                            <input type="text" id="Plating2_cost" name="Plating2_cost" class="easyui-numberbox" value="0" data-options="precision:2,groupSeparator:'.',decimalSeparator:','"/>
                        </div> 
                    </div>
