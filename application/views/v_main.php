...
<head>   
    <meta charset="UTF-8">
    <title>Aplikasi Cost Calculation</title>
    ...
    <div class="easyui-layout" fit="true" style="width:700px;height:350px;">
        ...
        <div data-options="region:'center'">
            <div id="tt" class="easyui-tabs" data-options="fit:true,border:false,plain:true" >
                <div title="Home" data-options="closable:false,href:'home',iconCls:'icon-home'" style="padding:10px"></div>
            </div>
            <div id="dlg">      
    ...
    <div id="dlg-reset_main" class="easyui-dialog" style="width:400px; height:150px; padding: 10px 20px" closed="true" buttons="#dlg-buttons-reset_main">
        <form id="fm-reset_main" method="post" novalidate>       
            <div class="fitem">
                ...
                <input id="pass" type="password" name="password" class="easyui-textbox" required/>
            </div>        
        </form>
    </div>
    <!-- Dialog Reset Button -->
